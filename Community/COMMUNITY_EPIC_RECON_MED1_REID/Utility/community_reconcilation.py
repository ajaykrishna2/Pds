...
class community_reconcilation_report:
    def Community(self,df,inf):
        # try:
            ...
            index_name2 = df4[((df4['Cancel Code']=='2')|(df4['Cancel Code']=='4')) & (df4['year3'] >= df4['year1']) & (df4['month3'] >= df4['month1']) & (
            ...
            save_file.send_statement(df4, 'Closed in FACS','COMMUNITY_EPIC_RECON_MED1_REID','Rec_Community')
            save_file.send_statement(df6, 'FACS not RECON','COMMUNITY_EPIC_RECON_MED1_REID','Rec_Community')
            save_file.send_statement(df5, 'RECON not FACS','COMMUNITY_EPIC_RECON_MED1_REID','Rec_Community')
            save_file.send_statement(df10, 'Balance Mismatch','COMMUNITY_EPIC_RECON_MED1_REID','Rec_Community')
            save_file.send_statement(df13, 'Balance Match','COMMUNITY_EPIC_RECON_MED1_REID','Rec_Community')
            save_file.send_statement(ad, 'Adjustments','COMMUNITY_EPIC_RECON_MED1_REID','Rec_Community')
