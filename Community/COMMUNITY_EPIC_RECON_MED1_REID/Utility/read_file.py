...
class read_input_for_reconcilation:
    ...
    def collect_and_preprocess_community_data(self):
        try:
            ...
            data = cli.get_object(Bucket=bucket_name, Key=reconcilation_input+"/Rec_Community/"+str(read_input_for_reconcilation.year)+"/"+read_input_for_reconcilation.month_name+"/"+"COMMUNITY_EPIC_RECON_MED1_REID_041221_61837.TXT")
            data = data['Body'].read()
