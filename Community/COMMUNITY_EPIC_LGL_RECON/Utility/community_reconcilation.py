...
class community_reconcilation_report:
    def Community(self,df,inf):
        # try:
            ...
            save_file.send_statement(df4, 'Closed in FACS','COMMUNITY_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(df6, 'FACS not RECON','COMMUNITY_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(df5, 'RECON not FACS','COMMUNITY_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(df10, 'Balance Mismatch','COMMUNITY_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(df13, 'Balance Match','COMMUNITY_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(ad, 'Adjustments','COMMUNITY_EPIC_LGL_RECON','Rec_Community')
