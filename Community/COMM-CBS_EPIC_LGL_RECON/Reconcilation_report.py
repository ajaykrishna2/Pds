from Utility.community_reconcilation import *
...
class Community_reconcilation:
    ...
    reconcilation_read = obj.collect_and_preprocess_community_data()
    
    
    #Creating exception report
    reconcilation = community_reconcilation_report()
    reconcilation.Community(reconcilation_read)
