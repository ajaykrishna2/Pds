...
class community_reconcilation_report:
    def Community(self,df,inf):
        # try:
            ...
            df = df.rename(columns={'Legal Flag_1': ''})
            ...
            save_file.send_statement(df4, 'Closed in FACS','COMM-CBS_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(df6, 'FACS not RECON','COMM-CBS_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(df5, 'RECON not FACS','COMM-CBS_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(df10, 'Balance Mismatch','COMM-CBS_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(df13, 'Balance Match','COMM-CBS_EPIC_LGL_RECON','Rec_Community')
            save_file.send_statement(ad, 'Adjustments','COMM-CBS_EPIC_LGL_RECON','Rec_Community')
