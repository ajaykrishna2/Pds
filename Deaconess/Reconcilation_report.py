from Utility.deaconess_reconcilation import *
...
class Deaconess_reconcilation:
    ...
    reconcilation_read = obj.collect_and_preprocess_deaconess_data()
    
    #Creating exception report
    exception = deaconess_reconcilation_report()
    exception.Deaconess(reconcilation_read)
