...
class read_input_for_reconcilation:
    ...
    def collect_and_preprocess_parkview_data(cls):
        try:
            ...
            data = cli.get_object(Bucket=bucket_name, Key=reconcilation_input + "/Rec_Parkview/" + str(cls.year) + "/" + cls.month_name + "/" + "PARKVIEW_EPIC_RECON_070821_7507.TXT")
            data = data['Body'].read()
            ...
            logging.info("read Parkview_reconcilation_statement file successfully")
