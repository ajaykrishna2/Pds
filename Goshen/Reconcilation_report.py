from Utility.goshen_reconcilation import *
...
class Goshen_reconcilation:
    ...
    reconcilation_read = obj.collect_and_preprocess_goshen_data()
    
    #Creating exception report
    exception = goshen_reconcilation_report()
    exception.Goshen(reconcilation_read)
