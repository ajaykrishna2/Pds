...
class harrison_reconcilation_report:
    def Harrison(self,df,inf):
        # try:
            ...
            inf3['Disposition']=inf3['Disposition'].astype(str)
            ...
            save_file.send_statement(df20, 'Closed in FACS','HA2_EO_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(df7, 'FACS not RECON','HA2_EO_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(df_r, 'RECON not FACS','HA2_EO_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(df26, 'Balance Mismatch','HA2_EO_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(df23, 'Balance Match','HA2_EO_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(dfw1, 'Multiples','HA2_EO_HOSP','Rec_Harrison_Hospital')
