...
class harrison_reconcilation_report:
    def Harrison(self,df,inf):
        # try:
            ...
            save_file.send_statement(df20, 'Closed in FACS','HA1_BD_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(df7, 'FACS not RECON','HA1_BD_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(inf3, 'RECON not FACS','HA1_BD_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(df24, 'Balance Mismatch','HA1_BD_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(df23, 'Balance Match','HA1_BD_HOSP','Rec_Harrison_Hospital')
            save_file.send_statement(dfw, 'Multiples','HA1_BD_HOSP','Rec_Harrison_Hospital')
